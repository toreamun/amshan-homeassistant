...
SENSOR_TYPES: dict[str, AmsHanSensorEntityDescription] = {
    ...
    for sensor in [
        ...
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_IMPORT_L1,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Active power import (Q1+Q4) phase L1",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_IMPORT_L2,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Active power import (Q1+Q4) phase L2",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_IMPORT_L3,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Active power import (Q1+Q4) phase L3",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
        ...
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_EXPORT_L1,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Active power export (Q2+Q3) phase L1",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_EXPORT_L2,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Active power export (Q2+Q3) phase L2",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_ACTIVE_POWER_EXPORT_L3,
            device_class=SensorDeviceClass.POWER,
            native_unit_of_measurement=ha_const.POWER_WATT,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Active power export (Q2+Q3) phase L3",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
        ...
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_IMPORT_L1,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Reactive power import (Q1+Q2) phase L1",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_IMPORT_L2,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Reactive power import (Q1+Q2) phase L2",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_IMPORT_L3,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_IMPORT,
            name="Reactive power import (Q1+Q2) phase L3",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
        ...
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_EXPORT_L1,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Reactive power export (Q3+Q4) phase L1",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_EXPORT_L2,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Reactive power export (Q3+Q4) phase L2",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
            key=obis_map.FIELD_REACTIVE_POWER_EXPORT_L3,
            device_class=SensorDeviceClass.REACTIVE_POWER,
            native_unit_of_measurement=ha_const.POWER_VOLT_AMPERE_REACTIVE,
            state_class=SensorStateClass.MEASUREMENT,
            icon=ICON_POWER_EXPORT,
            name="Reactive power export (Q3+Q4) phase L3",
            decimals=0,
            use_configured_scaling=True,
        ),
        AmsHanSensorEntityDescription(
